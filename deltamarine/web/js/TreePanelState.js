...
Ext.override(Ext.ux.state.TreePanel, {
    ...
    removeevents = ['resize', 'sortchange','columnresize','columnhide','columnshow','columnmove'];
    for(var e in removeevents) {
      ename = removeevents[e];
      tree.un(ename,tree.onStateChange, tree);
      tree.stateEventsByName[ename] = 0;
    }
		tree.addStateEvents(['itemexpand', 'itemcollapse']);
		...
		Ext.apply(tree, {
			...
			,applyState:function(state) {
				if(state) {
					Ext.apply(this, {stateHash: state});
