...
Ext.Loader.addClassPathMappings({
  "Delta": "app",
  "Delta.view.part.DayHolder": "app/view/part/DayArea.js",
  "Delta.view.part.ListItem": "app/view/part/List.js",
  "Delta.view.part.ListRenderer": "app/view/part/List.js",
  "Delta.view.part.SearchItem": "app/view/part/Search.js",
  "Delta.view.part.SearchRenderer": "app/view/part/Search.js",
  "Delta.view.timelog.DaychartHolder": "app/view/timelog/DaychartArea.js",
  "Delta.view.timelog.LabourTypeButton": "app/view/timelog/LabourField.js",
  "Delta.view.timelog.LabourTypeItem": "app/view/timelog/LabourField.js",
  "Delta.view.timelog.LabourTypeSelector": "app/view/timelog/LabourField.js",
  "Delta.view.timelog.ListItem": "app/view/timelog/List.js",
  "Delta.view.timelog.ListRenderer": "app/view/timelog/List.js",
  "Delta.view.workorder.Item": "app/view/workorder/Search.js",
  "Delta.view.workorder.Renderer": "app/view/workorder/Search.js",
  "Delta.view.workorder.TaskItem": "app/view/workorder/TaskField.js",
  "Delta.view.workorder.TaskRenderer": "app/view/workorder/TaskField.js",
  "Delta.view.workorder.TaskSelector": "app/view/workorder/TaskField.js",
  "Ext": "touch/src",
  ...
  "LoginListButton": "app/view/LoginList.js",
  "LoginListItem": "app/view/LoginList.js"
});
Ext.ClassManager.addNameAlternateMappings({
  "Delta.controller.ChangePassword": [],
  "Delta.controller.Home": [],
  "Delta.controller.Login": [],
  "Delta.controller.PartAdd": [],
  "Delta.controller.PartHome": [],
  "Delta.controller.PartPutBack": [],
  "Delta.controller.TimelogAdd": [],
  "Delta.controller.TimelogHome": [],
  "Delta.controller.WorkorderHome": [],
  "Delta.model.Category": [],
  "Delta.model.Employee": [],
  "Delta.model.LabourType": [],
  "Delta.model.NonbillType": [],
  "Delta.model.Part": [],
  "Delta.model.PartCategory": [],
  "Delta.model.PartInstance": [],
  "Delta.model.Task": [],
  "Delta.model.Timelog": [],
  "Delta.model.Workorder": [],
  "Delta.profile.Kiosk": [],
  "Delta.profile.Phone": [],
  "Delta.profile.Tablet": [],
  "Delta.store.Category": [],
  "Delta.store.Employee": [],
  "Delta.store.LabourType": [],
  "Delta.store.NonbillType": [],
  "Delta.store.PartCategory": [],
  "Delta.store.Timelog": [],
  "Delta.store.Workorder": [],
  "Delta.view.ChangePassword": [],
  "Delta.view.Home": [],
  "Delta.view.Login": [],
...
Ext.ClassManager.addNameAliasMappings({
  ...
  "Delta.view.timelog.BillableField": [
    "widget.billablefield"
  ],
  "Delta.view.timelog.Daychart": [
    "widget.timelogdaychart"
  ],
  "Delta.view.timelog.DaychartArea": [
    "widget.timelogdaychartarea"
  ],
  "Delta.view.timelog.DaychartHolder": [
    "widget.timelogdaychartholder"
  ],
  "Delta.view.timelog.Home": [
    "widget.timeloghome"
  ],
  ...
  "Delta.view.timelog.LabourField": [
    "widget.labourtypefield"
  ],
  "Delta.view.timelog.LabourTypeButton": [
    "widget.labourtypebutton"
  ],
  "Delta.view.timelog.LabourTypeItem": [
    "widget.labourtypeitem"
  ],
  "Delta.view.timelog.LabourTypeSelector": [
    "widget.labourtypeselector"
  ],
  "Delta.view.timelog.List": [
    "widget.timeloglist"
  ],
  "Delta.view.timelog.ListItem": [
    "widget.timeloglistitem"
  ],
  "Delta.view.timelog.ListRenderer": [],
  "Delta.view.timelog.Weekchart": [
    "widget.timelogweekchart"
  ],
  "Delta.view.timelog.WeekchartArea": [
    "widget.timelogweekchartarea"
  ],
  "Delta.view.workorder.Field": [
    "widget.workorderfield"
  ],
  "Delta.view.workorder.Home": [
    "widget.workorderhome"
  ],
  "Delta.view.workorder.Item": [
