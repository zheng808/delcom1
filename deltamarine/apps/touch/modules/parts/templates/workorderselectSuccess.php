<div id="filter">
  ...
  <div class="filter-area">
    ...
    <div class="filter-options">
      <?php $base_url = 'parts/workorderselect?'. ($filter_boat ? 'filter_boat='.$filter_boat.'&' : '').'filter_name='; ?>
    ...
    <div class="filter-options">
      <?php $base_url = 'parts/workorderselect?'. ($filter_name ? 'filter_name='.$filter_name.'&' : '').'filter_boat='; ?>
...
<div id="results">
  ...
  <?php if (count($workorders) > 0): ?>
    <?php foreach ($workorders AS $workorder): ?>
      ...
      <?php endif; ?>
      <div class="woselect">
        <a class="button" href="<?php echo url_for('parts/workorderitemselect?id='.$workorder->getId()); ?>" class="buttonlink woselect-link">
  ...
  <div class="pager">
    <?php if ($pager->haveToPaginate()): ?>
        <?php $base_url = 'parts/workorderselect?'.($filter_name ? 'filter_name='.$filter_name.'&' : '').($filter_boat ? 'filter_boat='.$filter_boat.'&' : '').'page='; ?>
