...
abstract class BaseFilePeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Filename', 'Description', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'filename', 'description', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::FILENAME, self::DESCRIPTION, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'filename', 'description', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Filename' => 1, 'Description' => 2, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'filename' => 1, 'description' => 2, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::FILENAME => 1, self::DESCRIPTION => 2, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'filename' => 1, 'description' => 2, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new FileMapBuilder();
		}
    ...
    foreach (sfMixer::getCallables('BaseFilePeer:doCount:doCount') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseFilePeer:doSelectStmt:doSelectStmt') as $callable)
    {
      call_user_func($callable, 'BaseFilePeer', $criteria, $con);
    }
...
//
// NOTE: This static code cannot call methods on the FilePeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the FilePeer class:
//
// Propel::getDatabaseMap(FilePeer::DATABASE_NAME)->addTableBuilder(FilePeer::TABLE_NAME, FilePeer::getMapBuilder());
//
// Doing so will effectively overwrite the registration below.

Propel::getDatabaseMap(BaseFilePeer::DATABASE_NAME)->addTableBuilder(BaseFilePeer::TABLE_NAME, BaseFilePeer::getMapBuilder());
