...
abstract class BaseEmployeePeer {
	...
	const WF_CRM_ID = 'employee.WF_CRM_ID';

	/** the column name for the GUARD_USER_ID field */
	const GUARD_USER_ID = 'employee.GUARD_USER_ID';

	/** the column name for the PAYRATE field */
	const PAYRATE = 'employee.PAYRATE';

	/** the column name for the HIDDEN field */
	const HIDDEN = 'employee.HIDDEN';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'WfCrmId', 'GuardUserId', 'Payrate', 'Hidden', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'wfCrmId', 'guardUserId', 'payrate', 'hidden', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::WF_CRM_ID, self::GUARD_USER_ID, self::PAYRATE, self::HIDDEN, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'wf_crm_id', 'guard_user_id', 'payrate', 'hidden', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'WfCrmId' => 1, 'GuardUserId' => 2, 'Payrate' => 3, 'Hidden' => 4, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'wfCrmId' => 1, 'guardUserId' => 2, 'payrate' => 3, 'hidden' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::WF_CRM_ID => 1, self::GUARD_USER_ID => 2, self::PAYRATE => 3, self::HIDDEN => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'wf_crm_id' => 1, 'guard_user_id' => 2, 'payrate' => 3, 'hidden' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(EmployeePeer::WF_CRM_ID);

		$criteria->addSelectColumn(EmployeePeer::GUARD_USER_ID);

		$criteria->addSelectColumn(EmployeePeer::PAYRATE);

		$criteria->addSelectColumn(EmployeePeer::HIDDEN);
	...
	public static function doCountJoinwfCRM(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(EmployeePeer::WF_CRM_ID,), array(wfCRMPeer::ID,), $join_behavior);
	...
	public static function doCountJoinsfGuardUser(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(EmployeePeer::GUARD_USER_ID,), array(sfGuardUserPeer::ID,), $join_behavior);
	...
	/**
	 * Selects a collection of Employee objects pre-filled with their wfCRM objects.
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    foreach (sfMixer::getCallables('BaseEmployeePeer:doSelectJoin:doSelectJoin') as $callable)
    {
      call_user_func($callable, 'BaseEmployeePeer', $c, $con);
		...
		$c->addJoin(array(EmployeePeer::WF_CRM_ID,), array(wfCRMPeer::ID,), $join_behavior);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Employee) to $obj2 (wfCRM)
	...
	/**
	 * Selects a collection of Employee objects pre-filled with their sfGuardUser objects.
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of Employee objects.
	...
	public static function doSelectJoinsfGuardUser(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$c->addJoin(array(EmployeePeer::GUARD_USER_ID,), array(sfGuardUserPeer::ID,), $join_behavior);
		$stmt = BasePeer::doSelect($c, $con);
		$results = array();
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Employee) to $obj2 (sfGuardUser)
				$obj2->addEmployee($obj1);
      ...
      call_user_func($callable, 'BaseEmployeePeer', $c, $con);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Employee) to the collection in $obj2 (wfCRM)
				$obj2->addEmployee($obj1);
			...
			if ($key3 !== null) {
				...
				// Add the $obj1 (Employee) to the collection in $obj3 (sfGuardUser)
	...
	/**
	 * Selects a collection of Employee objects pre-filled with all related objects except wfCRM.
	 *
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
      ...
      call_user_func($callable, 'BaseEmployeePeer', $c, $con);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if (null !== ($obj1 = EmployeePeer::getInstanceFromPool($key1))) {
				...
				// Add the $obj1 (Employee) to the collection in $obj2 (sfGuardUser)
				$obj2->addEmployee($obj1);
	...
	/**
	 * Selects a collection of Employee objects pre-filled with all related objects except sfGuardUser.
	 *
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
