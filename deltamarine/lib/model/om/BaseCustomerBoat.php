...
/**
 * Base class that represents a row from the 'customer_boat' table.
 *
 * 
 *
 * @package    lib.model.om
 */
abstract class BaseCustomerBoat extends BaseObject  implements Persistent {


  const PEER = 'CustomerBoatPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        CustomerBoatPeer
	 */
	...
	/**
	 * Initializes internal state of BaseCustomerBoat object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     CustomerBoat The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = CustomerBoatPeer::ID;
		}
	...
	public function setCustomerId($v)
	{
		...
		if ($this->customer_id !== $v) {
			$this->customer_id = $v;
			$this->modifiedColumns[] = CustomerBoatPeer::CUSTOMER_ID;
		}
	...
	public function setSerialNumber($v)
	{
		...
		if ($this->serial_number !== $v) {
			...
			$this->modifiedColumns[] = CustomerBoatPeer::SERIAL_NUMBER;
		}
	...
	public function setMake($v)
	{
		...
		if ($this->make !== $v) {
			$this->make = $v;
			$this->modifiedColumns[] = CustomerBoatPeer::MAKE;
		}
	...
	public function setModel($v)
	{
		...
		if ($this->model !== $v) {
			$this->model = $v;
			$this->modifiedColumns[] = CustomerBoatPeer::MODEL;
		}
	...
	public function setName($v)
	{
		...
		if ($this->name !== $v) {
			$this->name = $v;
			$this->modifiedColumns[] = CustomerBoatPeer::NAME;
		}
	...
	public function setRegistration($v)
	{
		...
		if ($this->registration !== $v) {
			$this->registration = $v;
			$this->modifiedColumns[] = CustomerBoatPeer::REGISTRATION;
		}
	...
	public function setNotes($v)
	{
		...
		if ($this->notes !== $v) {
			$this->notes = $v;
			$this->modifiedColumns[] = CustomerBoatPeer::NOTES;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->serial_number = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			...
			return $startcol + 8; // 8 = CustomerBoatPeer::NUM_COLUMNS - CustomerBoatPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating CustomerBoat object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = CustomerBoatPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    foreach (sfMixer::getCallables('BaseCustomerBoat:delete:pre') as $callable)
    {
      ...
      if ($ret)
      {
		...
		try {
			CustomerBoatPeer::doDelete($this, $con);
    ...
    foreach (sfMixer::getCallables('BaseCustomerBoat:delete:post') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseCustomerBoat:save:pre') as $callable)
    {
      ...
      if (is_int($affectedRows))
      {
		...
		try {
			...
			$con->commit();
    foreach (sfMixer::getCallables('BaseCustomerBoat:save:post') as $callable)
    {
      call_user_func($callable, $this, $con, $affectedRows);
    }

			CustomerBoatPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = CustomerBoatPeer::doInsert($this, $con);
					...
					$affectedRows += CustomerBoatPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = CustomerBoatPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = CustomerBoatPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = CustomerBoatPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CustomerBoatPeer::ID)) $criteria->add(CustomerBoatPeer::ID, $this->id);
		if ($this->isColumnModified(CustomerBoatPeer::CUSTOMER_ID)) $criteria->add(CustomerBoatPeer::CUSTOMER_ID, $this->customer_id);
		if ($this->isColumnModified(CustomerBoatPeer::SERIAL_NUMBER)) $criteria->add(CustomerBoatPeer::SERIAL_NUMBER, $this->serial_number);
		if ($this->isColumnModified(CustomerBoatPeer::MAKE)) $criteria->add(CustomerBoatPeer::MAKE, $this->make);
		if ($this->isColumnModified(CustomerBoatPeer::MODEL)) $criteria->add(CustomerBoatPeer::MODEL, $this->model);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(CustomerBoatPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of CustomerBoat (or compatible) type.
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setRegistration($this->registration);
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     CustomerBoat Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     CustomerBoatPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new CustomerBoatPeer();
		}
		return self::$peer;
	}
	...
	public function getCustomer(PropelPDO $con = null)
	{
		if ($this->aCustomer === null && ($this->customer_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aCustomer->addCustomerBoats($this);
			 */
		}
	 ...
	 * Otherwise if this CustomerBoat has previously been saved, it will retrieve
	 * related Workorders from storage. If this CustomerBoat is new, it will return
		...
		if ($this->collWorkorders === null) {
			if ($this->isNew()) {
			   $this->collWorkorders = array();
				...
				$criteria->add(WorkorderPeer::CUSTOMER_BOAT_ID, $this->id);
	 ...
	 * Otherwise if this CustomerBoat is new, it will return
	 * an empty collection; or if this CustomerBoat has previously
	 * been saved, it will retrieve related Workorders from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in CustomerBoat.
	 */
	public function getWorkordersJoinCustomer($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(CustomerBoatPeer::DATABASE_NAME);
		}
		...
		if ($this->collWorkorders === null) {
			if ($this->isNew()) {
				...
				$this->collWorkorders = WorkorderPeer::doSelectJoinCustomer($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
  ...
  {
    if (!$callable = sfMixer::getCallable('BaseCustomerBoat:'.$method))
    {
      throw new sfException(sprintf('Call to undefined method BaseCustomerBoat::%s', $method));
    }
