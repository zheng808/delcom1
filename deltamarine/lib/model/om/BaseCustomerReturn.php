...
/**
 * Base class that represents a row from the 'customer_return' table.
 *
 * 
 *
 * @package    lib.model.om
 */
abstract class BaseCustomerReturn extends BaseObject  implements Persistent {


  const PEER = 'CustomerReturnPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        CustomerReturnPeer
	 */
	...
	/**
	 * The value for the date_returned field.
	 * @var        string
	 */
	...
	/**
	 * Initializes internal state of BaseCustomerReturn object.
	 * @see        applyDefaults()
	 */
	...
	/**
	 * Get the [optionally formatted] temporal [date_returned] column value.
	 * 
	 *
	 ...
	 */
	public function getDateReturned($format = 'Y-m-d H:i:s')
	{
		...
		if ($this->date_returned === '0000-00-00 00:00:00') {
			// while technically this is not a default value of NULL,
			// this seems to be closest in meaning.
			return null;
		} else {
			try {
				$dt = new DateTime($this->date_returned);
			} catch (Exception $x) {
				throw new PropelException("Internally stored date/time/timestamp value could not be converted to DateTime: " . var_export($this->date_returned, true), $x);
			}
		}
	 ...
	 * @return     CustomerReturn The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = CustomerReturnPeer::ID;
		}
	...
	public function setCustomerOrderId($v)
	{
		...
		if ($this->customer_order_id !== $v) {
			...
			$this->modifiedColumns[] = CustomerReturnPeer::CUSTOMER_ORDER_ID;
		}
	...
	public function setInvoiceId($v)
	{
		...
		if ($this->invoice_id !== $v) {
			$this->invoice_id = $v;
			$this->modifiedColumns[] = CustomerReturnPeer::INVOICE_ID;
		}
	...
	/**
	 * Sets the value of [date_returned] column to a normalized version of the date/time value specified.
	 * 
	 * @param      mixed $v string, integer (timestamp), or DateTime value.  Empty string will
	 *						be treated as NULL for temporal objects.
	 * @return     CustomerReturn The current object (for fluent API support)
	 */
	public function setDateReturned($v)
	{
		...
		if ( $this->date_returned !== null || $dt !== null ) {
			// (nested ifs are a little easier to read in this case)

			$currNorm = ($this->date_returned !== null && $tmpDt = new DateTime($this->date_returned)) ? $tmpDt->format('Y-m-d H:i:s') : null;
			$newNorm = ($dt !== null) ? $dt->format('Y-m-d H:i:s') : null;

			if ( ($currNorm !== $newNorm) // normalized values don't match 
					)
			{
				$this->date_returned = ($dt ? $dt->format('Y-m-d H:i:s') : null);
				$this->modifiedColumns[] = CustomerReturnPeer::DATE_RETURNED;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->date_returned = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
			$this->resetModified();
			...
			return $startcol + 4; // 4 = CustomerReturnPeer::NUM_COLUMNS - CustomerReturnPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating CustomerReturn object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = CustomerReturnPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    foreach (sfMixer::getCallables('BaseCustomerReturn:delete:pre') as $callable)
    {
      ...
      if ($ret)
      {
		...
		try {
			CustomerReturnPeer::doDelete($this, $con);
    ...
    foreach (sfMixer::getCallables('BaseCustomerReturn:delete:post') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseCustomerReturn:save:pre') as $callable)
    {
      ...
      if (is_int($affectedRows))
      {
		...
		try {
			...
			$con->commit();
    foreach (sfMixer::getCallables('BaseCustomerReturn:save:post') as $callable)
    {
      call_user_func($callable, $this, $con, $affectedRows);
    }

			CustomerReturnPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = CustomerReturnPeer::doInsert($this, $con);
					...
					$affectedRows += CustomerReturnPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = CustomerReturnPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = CustomerReturnPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = CustomerReturnPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
			$keys[1] => $this->getCustomerOrderId(),
			$keys[2] => $this->getInvoiceId(),
			$keys[3] => $this->getDateReturned(),
		);
		return $result;
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[3], $arr)) $this->setDateReturned($arr[$keys[3]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CustomerReturnPeer::ID)) $criteria->add(CustomerReturnPeer::ID, $this->id);
		if ($this->isColumnModified(CustomerReturnPeer::CUSTOMER_ORDER_ID)) $criteria->add(CustomerReturnPeer::CUSTOMER_ORDER_ID, $this->customer_order_id);
		if ($this->isColumnModified(CustomerReturnPeer::INVOICE_ID)) $criteria->add(CustomerReturnPeer::INVOICE_ID, $this->invoice_id);
		if ($this->isColumnModified(CustomerReturnPeer::DATE_RETURNED)) $criteria->add(CustomerReturnPeer::DATE_RETURNED, $this->date_returned);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(CustomerReturnPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of CustomerReturn (or compatible) type.
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setDateReturned($this->date_returned);
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     CustomerReturn Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     CustomerReturnPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new CustomerReturnPeer();
		}
		return self::$peer;
	}
	...
	public function getCustomerOrder(PropelPDO $con = null)
	{
		if ($this->aCustomerOrder === null && ($this->customer_order_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aCustomerOrder->addCustomerReturns($this);
			 */
		}
	...
	public function getInvoice(PropelPDO $con = null)
	{
		if ($this->aInvoice === null && ($this->invoice_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aInvoice->addCustomerReturns($this);
			 */
		}
	 ...
	 * Otherwise if this CustomerReturn has previously been saved, it will retrieve
	 * related CustomerReturnItems from storage. If this CustomerReturn is new, it will return
		...
		if ($this->collCustomerReturnItems === null) {
			if ($this->isNew()) {
			   $this->collCustomerReturnItems = array();
				...
				$criteria->add(CustomerReturnItemPeer::CUSTOMER_RETURN_ID, $this->id);
	 ...
	 * Otherwise if this CustomerReturn is new, it will return
	 * an empty collection; or if this CustomerReturn has previously
	 * been saved, it will retrieve related CustomerReturnItems from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in CustomerReturn.
	 */
  ...
  {
    if (!$callable = sfMixer::getCallable('BaseCustomerReturn:'.$method))
    {
      throw new sfException(sprintf('Call to undefined method BaseCustomerReturn::%s', $method));
    }
