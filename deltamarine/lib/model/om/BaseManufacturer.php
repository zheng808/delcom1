 ...
 */
abstract class BaseManufacturer extends BaseObject  implements Persistent {


  const PEER = 'ManufacturerPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        ManufacturerPeer
	 */
	...
	/**
	 * @var        array Part[] Collection to store aggregation of Part objects.
	 */
	protected $collParts;

	/**
	 * @var        Criteria The criteria used to select the current contents of collParts.
	 */
	private $lastPartCriteria = null;
	...
	/**
	 * Initializes internal state of BaseManufacturer object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     Manufacturer The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = ManufacturerPeer::ID;
		}
	...
	public function setWfCrmId($v)
	{
		...
		if ($this->wf_crm_id !== $v) {
			$this->wf_crm_id = $v;
			$this->modifiedColumns[] = ManufacturerPeer::WF_CRM_ID;
		}
	...
	public function setHidden($v)
	{
		...
		if ($this->hidden !== $v || $v === false) {
			$this->hidden = $v;
			$this->modifiedColumns[] = ManufacturerPeer::HIDDEN;
		}
	...
	public function hasOnlyDefaultValues()
	{
			...
			if (array_diff($this->modifiedColumns, array(ManufacturerPeer::HIDDEN))) {
				return false;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 3; // 3 = ManufacturerPeer::NUM_COLUMNS - ManufacturerPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating Manufacturer object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = ManufacturerPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    foreach (sfMixer::getCallables('BaseManufacturer:delete:pre') as $callable)
    {
      ...
      if ($ret)
      {
		...
		try {
			ManufacturerPeer::doDelete($this, $con);
    ...
    foreach (sfMixer::getCallables('BaseManufacturer:delete:post') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseManufacturer:save:pre') as $callable)
    {
      ...
      if (is_int($affectedRows))
      {
		...
		try {
			...
			$con->commit();
    foreach (sfMixer::getCallables('BaseManufacturer:save:post') as $callable)
    {
      call_user_func($callable, $this, $con, $affectedRows);
    }

			ManufacturerPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = ManufacturerPeer::doInsert($this, $con);
					...
					$affectedRows += ManufacturerPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = ManufacturerPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = ManufacturerPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = ManufacturerPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ManufacturerPeer::ID)) $criteria->add(ManufacturerPeer::ID, $this->id);
		if ($this->isColumnModified(ManufacturerPeer::WF_CRM_ID)) $criteria->add(ManufacturerPeer::WF_CRM_ID, $this->wf_crm_id);
		if ($this->isColumnModified(ManufacturerPeer::HIDDEN)) $criteria->add(ManufacturerPeer::HIDDEN, $this->hidden);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(ManufacturerPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Manufacturer (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Manufacturer Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     ManufacturerPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new ManufacturerPeer();
		}
		return self::$peer;
	}
	...
	public function getwfCRM(PropelPDO $con = null)
	{
		if ($this->awfCRM === null && ($this->wf_crm_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->awfCRM->addManufacturers($this);
			 */
		}
		return $this->awfCRM;
	}
	...
	/**
	 * Clears out the collParts collection (array).
	 *
	...
	/**
	 * Initializes the collParts collection (array).
	 *
	...
	{
		$this->collParts = array();
	}

	/**
	 * Gets an array of Part objects which contain a foreign key that references this object.
	 *
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Manufacturer has previously been saved, it will retrieve
	 * related Parts from storage. If this Manufacturer is new, it will return
	 ...
	 * @throws     PropelException
	 */
	public function getParts($criteria = null, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(ManufacturerPeer::DATABASE_NAME);
		}
		...
		if ($this->collParts === null) {
			if ($this->isNew()) {
			   $this->collParts = array();
				...
				$criteria->add(PartPeer::MANUFACTURER_ID, $this->id);

				PartPeer::addSelectColumns($criteria);
				$this->collParts = PartPeer::doSelect($criteria, $con);
			}
		} else {
			...
			if (!$this->isNew()) {
				...
				PartPeer::addSelectColumns($criteria);
				if (!isset($this->lastPartCriteria) || !$this->lastPartCriteria->equals($criteria)) {
					$this->collParts = PartPeer::doSelect($criteria, $con);
				}
			}
		}
		$this->lastPartCriteria = $criteria;
		return $this->collParts;
	}

	/**
	 * Returns the number of related Part objects.
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct
	 * @param      PropelPDO $con
	 * @return     int Count of related Part objects.
	 * @throws     PropelException
	 */
	public function countParts(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(ManufacturerPeer::DATABASE_NAME);
		} else {
		...
		if ($this->collParts === null) {
			if ($this->isNew()) {
				...
				$count = PartPeer::doCount($criteria, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
	...
	/**
	 * Method called to associate a Part object to this object
	 * through the Part foreign key attribute.
	 *
	 * @param      Part $l Part
	 * @return     void
	 * @throws     PropelException
	 */
	public function addPart(Part $l)
	{
		if ($this->collParts === null) {
			$this->initParts();
		}
		if (!in_array($l, $this->collParts, true)) { // only add it if the **same** object is not already associated
			array_push($this->collParts, $l);
			$l->setManufacturer($this);
		}
	}
	 ...
	 * been saved, it will retrieve related Parts from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in Manufacturer.
	 */
	public function getPartsJoinPartCategory($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(ManufacturerPeer::DATABASE_NAME);
		}
		...
		if ($this->collParts === null) {
			if ($this->isNew()) {
				...
				$this->collParts = PartPeer::doSelectJoinPartCategory($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Manufacturer has previously been saved, it will retrieve
	 * related WorkorderItemBillables from storage. If this Manufacturer is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collWorkorderItemBillables === null) {
			if ($this->isNew()) {
			   $this->collWorkorderItemBillables = array();
				...
				$criteria->add(WorkorderItemBillablePeer::MANUFACTURER_ID, $this->id);
	 ...
	 * actually need in Manufacturer.
	 */
	public function getWorkorderItemBillablesJoinWorkorderItem($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(ManufacturerPeer::DATABASE_NAME);
		}
		...
		if ($this->collWorkorderItemBillables === null) {
			if ($this->isNew()) {
				...
				$this->collWorkorderItemBillables = WorkorderItemBillablePeer::doSelectJoinWorkorderItem($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Manufacturer has previously been saved, it will retrieve
	 * related WorkorderPayments from storage. If this Manufacturer is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collWorkorderPayments === null) {
			if ($this->isNew()) {
			   $this->collWorkorderPayments = array();
				...
				$criteria->add(WorkorderPaymentPeer::MANUFACTURER_ID, $this->id);
	 ...
	 * actually need in Manufacturer.
	 */
	public function getWorkorderPaymentsJoinWorkorder($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(ManufacturerPeer::DATABASE_NAME);
		}
		...
		if ($this->collWorkorderPayments === null) {
			if ($this->isNew()) {
				...
				$this->collWorkorderPayments = WorkorderPaymentPeer::doSelectJoinWorkorder($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Manufacturer has previously been saved, it will retrieve
	 * related Invoices from storage. If this Manufacturer is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collInvoices === null) {
			if ($this->isNew()) {
			   $this->collInvoices = array();
				...
				$criteria->add(InvoicePeer::MANUFACTURER_ID, $this->id);
	 ...
	 * actually need in Manufacturer.
	 */
	public function getInvoicesJoinCustomer($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(ManufacturerPeer::DATABASE_NAME);
		}
		...
		if ($this->collInvoices === null) {
			if ($this->isNew()) {
				...
				$this->collInvoices = InvoicePeer::doSelectJoinCustomer($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	...
	public function clearAllReferences($deep = false)
	{
		if ($deep) {
			if ($this->collParts) {
				foreach ((array) $this->collParts as $o) {
  ...
  {
    if (!$callable = sfMixer::getCallable('BaseManufacturer:'.$method))
    {
      throw new sfException(sprintf('Call to undefined method BaseManufacturer::%s', $method));
    }
