...
/**
 * Base class that represents a row from the 'workorder_item_file' table.
 *
 * 
 *
 * @package    lib.model.om
 */
abstract class BaseWorkorderItemFile extends BaseObject  implements Persistent {


  const PEER = 'WorkorderItemFilePeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        WorkorderItemFilePeer
	 */
	...
	/**
	 * Initializes internal state of BaseWorkorderItemFile object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     WorkorderItemFile The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = WorkorderItemFilePeer::ID;
		}
	...
	public function setWorkorderItemId($v)
	{
		...
		if ($this->workorder_item_id !== $v) {
			...
			$this->modifiedColumns[] = WorkorderItemFilePeer::WORKORDER_ITEM_ID;
		}
	...
	public function setFileId($v)
	{
		...
		if ($this->file_id !== $v) {
			$this->file_id = $v;
			$this->modifiedColumns[] = WorkorderItemFilePeer::FILE_ID;
		}
	...
	public function setCreatedAt($v)
	{
		...
		if ( $this->created_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = WorkorderItemFilePeer::CREATED_AT;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 4; // 4 = WorkorderItemFilePeer::NUM_COLUMNS - WorkorderItemFilePeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating WorkorderItemFile object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = WorkorderItemFilePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    foreach (sfMixer::getCallables('BaseWorkorderItemFile:delete:pre') as $callable)
    {
      ...
      if ($ret)
      {
		...
		try {
			WorkorderItemFilePeer::doDelete($this, $con);
    ...
    foreach (sfMixer::getCallables('BaseWorkorderItemFile:delete:post') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseWorkorderItemFile:save:pre') as $callable)
    {
    ...
    if ($this->isNew() && !$this->isColumnModified(WorkorderItemFilePeer::CREATED_AT))
    {
      $this->setCreatedAt(time());
		...
		try {
			...
			$con->commit();
    foreach (sfMixer::getCallables('BaseWorkorderItemFile:save:post') as $callable)
    {
      call_user_func($callable, $this, $con, $affectedRows);
    }

			WorkorderItemFilePeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = WorkorderItemFilePeer::doInsert($this, $con);
					...
					$affectedRows += WorkorderItemFilePeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = WorkorderItemFilePeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = WorkorderItemFilePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = WorkorderItemFilePeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(WorkorderItemFilePeer::ID)) $criteria->add(WorkorderItemFilePeer::ID, $this->id);
		if ($this->isColumnModified(WorkorderItemFilePeer::WORKORDER_ITEM_ID)) $criteria->add(WorkorderItemFilePeer::WORKORDER_ITEM_ID, $this->workorder_item_id);
		if ($this->isColumnModified(WorkorderItemFilePeer::FILE_ID)) $criteria->add(WorkorderItemFilePeer::FILE_ID, $this->file_id);
		if ($this->isColumnModified(WorkorderItemFilePeer::CREATED_AT)) $criteria->add(WorkorderItemFilePeer::CREATED_AT, $this->created_at);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(WorkorderItemFilePeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of WorkorderItemFile (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     WorkorderItemFile Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     WorkorderItemFilePeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new WorkorderItemFilePeer();
		}
		return self::$peer;
	}
	...
	public function getWorkorderItem(PropelPDO $con = null)
	{
		if ($this->aWorkorderItem === null && ($this->workorder_item_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aWorkorderItem->addWorkorderItemFiles($this);
			 */
		}
	...
	public function getFile(PropelPDO $con = null)
	{
		if ($this->aFile === null && ($this->file_id !== null)) {
			...
			$c->add(FilePeer::ID, $this->file_id);
			$this->aFile = FilePeer::doSelectOne($c, $con);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aFile->addWorkorderItemFiles($this);
			 */
		}
		return $this->aFile;
	}
  ...
  {
    if (!$callable = sfMixer::getCallable('BaseWorkorderItemFile:'.$method))
    {
      throw new sfException(sprintf('Call to undefined method BaseWorkorderItemFile::%s', $method));
    }
