...
/**
 * Base class that represents a row from the 'labour_type' table.
 *
 * 
 *
 * @package    lib.model.om
 */
abstract class BaseLabourType extends BaseObject  implements Persistent {


  const PEER = 'LabourTypePeer';
	...
	/**
	 * The value for the hourly_rate field.
	 * @var        string
	 */
	...
	/**
	 * Initializes internal state of BaseLabourType object.
	 * @see        applyDefaults()
	 */
	...
	/**
	 * Get the [hourly_rate] column value.
	 * 
	 * @return     string
	 */
	 ...
	 * @return     LabourType The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = LabourTypePeer::ID;
		}
	...
	public function setName($v)
	{
		...
		if ($this->name !== $v) {
			$this->name = $v;
			$this->modifiedColumns[] = LabourTypePeer::NAME;
		}
	...
	/**
	 * Set the value of [hourly_rate] column.
	 * 
	 * @param      string $v new value
	 * @return     LabourType The current object (for fluent API support)
	 */
	public function setHourlyRate($v)
	{
		...
		if ($this->hourly_rate !== $v) {
			$this->hourly_rate = $v;
			$this->modifiedColumns[] = LabourTypePeer::HOURLY_RATE;
		}
	...
	public function setActive($v)
	{
		...
		if ($this->active !== $v || $v === true) {
			$this->active = $v;
			$this->modifiedColumns[] = LabourTypePeer::ACTIVE;
		}
	...
	public function hasOnlyDefaultValues()
	{
			...
			if (array_diff($this->modifiedColumns, array(LabourTypePeer::ACTIVE))) {
				return false;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->hourly_rate = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			...
			return $startcol + 4; // 4 = LabourTypePeer::NUM_COLUMNS - LabourTypePeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating LabourType object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = LabourTypePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    foreach (sfMixer::getCallables('BaseLabourType:delete:pre') as $callable)
    {
      ...
      if ($ret)
      {
		...
		try {
			LabourTypePeer::doDelete($this, $con);
    ...
    foreach (sfMixer::getCallables('BaseLabourType:delete:post') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseLabourType:save:pre') as $callable)
    {
      ...
      if (is_int($affectedRows))
      {
		...
		try {
			...
			$con->commit();
    foreach (sfMixer::getCallables('BaseLabourType:save:post') as $callable)
    {
      call_user_func($callable, $this, $con, $affectedRows);
    }

			LabourTypePeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = LabourTypePeer::doInsert($this, $con);
					...
					$affectedRows += LabourTypePeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = LabourTypePeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = LabourTypePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = LabourTypePeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
			$keys[1] => $this->getName(),
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[2], $arr)) $this->setHourlyRate($arr[$keys[2]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(LabourTypePeer::ID)) $criteria->add(LabourTypePeer::ID, $this->id);
		if ($this->isColumnModified(LabourTypePeer::NAME)) $criteria->add(LabourTypePeer::NAME, $this->name);
		if ($this->isColumnModified(LabourTypePeer::HOURLY_RATE)) $criteria->add(LabourTypePeer::HOURLY_RATE, $this->hourly_rate);
		if ($this->isColumnModified(LabourTypePeer::ACTIVE)) $criteria->add(LabourTypePeer::ACTIVE, $this->active);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(LabourTypePeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of LabourType (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     LabourType Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     LabourTypePeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new LabourTypePeer();
		}
		return self::$peer;
	}
	 ...
	 * Otherwise if this LabourType has previously been saved, it will retrieve
	 * related Timelogs from storage. If this LabourType is new, it will return
		...
		if ($this->collTimelogs === null) {
			if ($this->isNew()) {
			   $this->collTimelogs = array();
				...
				$criteria->add(TimelogPeer::LABOUR_TYPE_ID, $this->id);
	 ...
	 * Otherwise if this LabourType is new, it will return
	 * an empty collection; or if this LabourType has previously
	 * been saved, it will retrieve related Timelogs from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in LabourType.
	 */
  ...
  {
    if (!$callable = sfMixer::getCallable('BaseLabourType:'.$method))
    {
      throw new sfException(sprintf('Call to undefined method BaseLabourType::%s', $method));
    }
