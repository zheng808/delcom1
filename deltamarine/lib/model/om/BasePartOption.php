...
/**
 * Base class that represents a row from the 'part_option' table.
 *
 * 
 *
 * @package    lib.model.om
 */
abstract class BasePartOption extends BaseObject  implements Persistent {


  const PEER = 'PartOptionPeer';
	...
	/**
	 * The value for the is_color field.
	...
	/**
	 * Initializes internal state of BasePartOption object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     PartOption The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = PartOptionPeer::ID;
		}
	...
	public function setPartId($v)
	{
		...
		if ($this->part_id !== $v) {
			$this->part_id = $v;
			$this->modifiedColumns[] = PartOptionPeer::PART_ID;
		}
	...
	public function setName($v)
	{
		...
		if ($this->name !== $v) {
			$this->name = $v;
			$this->modifiedColumns[] = PartOptionPeer::NAME;
		}
	...
	/**
	 * Set the value of [is_color] column.
	 * 
	 * @param      boolean $v new value
	 * @return     PartOption The current object (for fluent API support)
	 */
	public function setIsColor($v)
	{
		if ($v !== null) {
			$v = (boolean) $v;
		}

		if ($this->is_color !== $v || $v === false) {
			$this->is_color = $v;
			$this->modifiedColumns[] = PartOptionPeer::IS_COLOR;
		}
	...
	public function hasOnlyDefaultValues()
	{
			...
			if (array_diff($this->modifiedColumns, array(PartOptionPeer::IS_COLOR))) {
				return false;
			}

			if ($this->is_color !== false) {
				return false;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->is_color = ($row[$startcol + 3] !== null) ? (boolean) $row[$startcol + 3] : null;
			$this->resetModified();
			...
			return $startcol + 4; // 4 = PartOptionPeer::NUM_COLUMNS - PartOptionPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating PartOption object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = PartOptionPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    foreach (sfMixer::getCallables('BasePartOption:delete:pre') as $callable)
    {
      ...
      if ($ret)
      {
		...
		try {
			PartOptionPeer::doDelete($this, $con);
    ...
    foreach (sfMixer::getCallables('BasePartOption:delete:post') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BasePartOption:save:pre') as $callable)
    {
      ...
      if (is_int($affectedRows))
      {
		...
		try {
			...
			$con->commit();
    foreach (sfMixer::getCallables('BasePartOption:save:post') as $callable)
    {
      call_user_func($callable, $this, $con, $affectedRows);
    }

			PartOptionPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = PartOptionPeer::doInsert($this, $con);
					...
					$affectedRows += PartOptionPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = PartOptionPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = PartOptionPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = PartOptionPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
			$keys[1] => $this->getPartId(),
			$keys[2] => $this->getName(),
			$keys[3] => $this->getIsColor(),
		);
		return $result;
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[3], $arr)) $this->setIsColor($arr[$keys[3]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(PartOptionPeer::ID)) $criteria->add(PartOptionPeer::ID, $this->id);
		if ($this->isColumnModified(PartOptionPeer::PART_ID)) $criteria->add(PartOptionPeer::PART_ID, $this->part_id);
		if ($this->isColumnModified(PartOptionPeer::NAME)) $criteria->add(PartOptionPeer::NAME, $this->name);
		if ($this->isColumnModified(PartOptionPeer::IS_COLOR)) $criteria->add(PartOptionPeer::IS_COLOR, $this->is_color);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(PartOptionPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of PartOption (or compatible) type.
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setIsColor($this->is_color);
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     PartOption Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     PartOptionPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new PartOptionPeer();
		}
		return self::$peer;
	}
	...
	public function getPart(PropelPDO $con = null)
	{
		if ($this->aPart === null && ($this->part_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aPart->addPartOptions($this);
			 */
		}
		return $this->aPart;
	}
	 ...
	 * Otherwise if this PartOption has previously been saved, it will retrieve
	 * related PartOptionValues from storage. If this PartOption is new, it will return
		...
		if ($this->collPartOptionValues === null) {
			if ($this->isNew()) {
			   $this->collPartOptionValues = array();
				...
				$criteria->add(PartOptionValuePeer::PART_OPTION_ID, $this->id);
	 ...
	 * Otherwise if this PartOption is new, it will return
	 * an empty collection; or if this PartOption has previously
	 * been saved, it will retrieve related PartOptionValues from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in PartOption.
	 */
	public function getPartOptionValuesJoinPartVariant($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(PartOptionPeer::DATABASE_NAME);
		}
		...
		if ($this->collPartOptionValues === null) {
			if ($this->isNew()) {
				...
				$this->collPartOptionValues = PartOptionValuePeer::doSelectJoinPartVariant($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
  ...
  {
    if (!$callable = sfMixer::getCallable('BasePartOption:'.$method))
    {
      throw new sfException(sprintf('Call to undefined method BasePartOption::%s', $method));
    }
