...
/**
 * Base class that represents a row from the 'workorder_payment' table.
 *
 * 
 *
 * @package    lib.model.om
 */
abstract class BaseWorkorderPayment extends BaseObject  implements Persistent {


  const PEER = 'WorkorderPaymentPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        WorkorderPaymentPeer
	 */
	...
	/**
	 * Initializes internal state of BaseWorkorderPayment object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     WorkorderPayment The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = WorkorderPaymentPeer::ID;
		}
	...
	public function setWorkorderId($v)
	{
		...
		if ($this->workorder_id !== $v) {
			$this->workorder_id = $v;
			$this->modifiedColumns[] = WorkorderPaymentPeer::WORKORDER_ID;
		}
	...
	public function setSupplierId($v)
	{
		...
		if ($this->supplier_id !== $v) {
			$this->supplier_id = $v;
			$this->modifiedColumns[] = WorkorderPaymentPeer::SUPPLIER_ID;
		}
	...
	public function setManufacturerId($v)
	{
		...
		if ($this->manufacturer_id !== $v) {
			...
			$this->modifiedColumns[] = WorkorderPaymentPeer::MANUFACTURER_ID;
		}
	...
	public function setAmount($v)
	{
		...
		if ($this->amount !== $v) {
			$this->amount = $v;
			$this->modifiedColumns[] = WorkorderPaymentPeer::AMOUNT;
		}
	...
	public function setCreatedAt($v)
	{
		...
		if ( $this->created_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = WorkorderPaymentPeer::CREATED_AT;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->manufacturer_id = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
			...
			return $startcol + 6; // 6 = WorkorderPaymentPeer::NUM_COLUMNS - WorkorderPaymentPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating WorkorderPayment object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = WorkorderPaymentPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    foreach (sfMixer::getCallables('BaseWorkorderPayment:delete:pre') as $callable)
    {
      ...
      if ($ret)
      {
		...
		try {
			WorkorderPaymentPeer::doDelete($this, $con);
    ...
    foreach (sfMixer::getCallables('BaseWorkorderPayment:delete:post') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseWorkorderPayment:save:pre') as $callable)
    {
    ...
    if ($this->isNew() && !$this->isColumnModified(WorkorderPaymentPeer::CREATED_AT))
    {
      $this->setCreatedAt(time());
		...
		try {
			...
			$con->commit();
    foreach (sfMixer::getCallables('BaseWorkorderPayment:save:post') as $callable)
    {
      call_user_func($callable, $this, $con, $affectedRows);
    }

			WorkorderPaymentPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = WorkorderPaymentPeer::doInsert($this, $con);
					...
					$affectedRows += WorkorderPaymentPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = WorkorderPaymentPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = WorkorderPaymentPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = WorkorderPaymentPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
			$keys[1] => $this->getWorkorderId(),
			$keys[2] => $this->getSupplierId(),
			$keys[3] => $this->getManufacturerId(),
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[3], $arr)) $this->setManufacturerId($arr[$keys[3]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(WorkorderPaymentPeer::ID)) $criteria->add(WorkorderPaymentPeer::ID, $this->id);
		if ($this->isColumnModified(WorkorderPaymentPeer::WORKORDER_ID)) $criteria->add(WorkorderPaymentPeer::WORKORDER_ID, $this->workorder_id);
		if ($this->isColumnModified(WorkorderPaymentPeer::SUPPLIER_ID)) $criteria->add(WorkorderPaymentPeer::SUPPLIER_ID, $this->supplier_id);
		if ($this->isColumnModified(WorkorderPaymentPeer::MANUFACTURER_ID)) $criteria->add(WorkorderPaymentPeer::MANUFACTURER_ID, $this->manufacturer_id);
		if ($this->isColumnModified(WorkorderPaymentPeer::AMOUNT)) $criteria->add(WorkorderPaymentPeer::AMOUNT, $this->amount);
		if ($this->isColumnModified(WorkorderPaymentPeer::CREATED_AT)) $criteria->add(WorkorderPaymentPeer::CREATED_AT, $this->created_at);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(WorkorderPaymentPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of WorkorderPayment (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     WorkorderPayment Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     WorkorderPaymentPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new WorkorderPaymentPeer();
		}
		return self::$peer;
	}
	...
	public function getWorkorder(PropelPDO $con = null)
	{
		if ($this->aWorkorder === null && ($this->workorder_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aWorkorder->addWorkorderPayments($this);
			 */
		}
	...
	public function getSupplier(PropelPDO $con = null)
	{
		if ($this->aSupplier === null && ($this->supplier_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aSupplier->addWorkorderPayments($this);
			 */
		}
	...
	public function getManufacturer(PropelPDO $con = null)
	{
		if ($this->aManufacturer === null && ($this->manufacturer_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aManufacturer->addWorkorderPayments($this);
			 */
		}
  ...
  {
    if (!$callable = sfMixer::getCallable('BaseWorkorderPayment:'.$method))
    {
      throw new sfException(sprintf('Call to undefined method BaseWorkorderPayment::%s', $method));
    }
