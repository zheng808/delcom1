...
/**
 * Base class that represents a row from the 'customer_order_item' table.
 *
 * 
 *
 * @package    lib.model.om
 */
abstract class BaseCustomerOrderItem extends BaseObject  implements Persistent {


  const PEER = 'CustomerOrderItemPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        CustomerOrderItemPeer
	 */
	...
	/**
	 * Initializes internal state of BaseCustomerOrderItem object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     CustomerOrderItem The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = CustomerOrderItemPeer::ID;
		}
	...
	public function setCustomerOrderId($v)
	{
		...
		if ($this->customer_order_id !== $v) {
			...
			$this->modifiedColumns[] = CustomerOrderItemPeer::CUSTOMER_ORDER_ID;
		}
	...
	public function setPartInstanceId($v)
	{
		...
		if ($this->part_instance_id !== $v) {
			...
			$this->modifiedColumns[] = CustomerOrderItemPeer::PART_INSTANCE_ID;
		}
	...
	public function setQuantityCompleted($v)
	{
		...
		if ($this->quantity_completed !== $v || $v === '0') {
			...
			$this->modifiedColumns[] = CustomerOrderItemPeer::QUANTITY_COMPLETED;
		}
	...
	public function hasOnlyDefaultValues()
	{
			...
			if (array_diff($this->modifiedColumns, array(CustomerOrderItemPeer::QUANTITY_COMPLETED))) {
				return false;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->part_instance_id = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
			$this->quantity_completed = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
			$this->resetModified();
			...
			return $startcol + 4; // 4 = CustomerOrderItemPeer::NUM_COLUMNS - CustomerOrderItemPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating CustomerOrderItem object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = CustomerOrderItemPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    foreach (sfMixer::getCallables('BaseCustomerOrderItem:delete:pre') as $callable)
    {
      ...
      if ($ret)
      {
		...
		try {
			CustomerOrderItemPeer::doDelete($this, $con);
    ...
    foreach (sfMixer::getCallables('BaseCustomerOrderItem:delete:post') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseCustomerOrderItem:save:pre') as $callable)
    {
      ...
      if (is_int($affectedRows))
      {
		...
		try {
			...
			$con->commit();
    foreach (sfMixer::getCallables('BaseCustomerOrderItem:save:post') as $callable)
    {
      call_user_func($callable, $this, $con, $affectedRows);
    }

			CustomerOrderItemPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = CustomerOrderItemPeer::doInsert($this, $con);
					...
					$affectedRows += CustomerOrderItemPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = CustomerOrderItemPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = CustomerOrderItemPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = CustomerOrderItemPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
			$keys[1] => $this->getCustomerOrderId(),
			$keys[2] => $this->getPartInstanceId(),
			$keys[3] => $this->getQuantityCompleted(),
		);
		return $result;
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[2], $arr)) $this->setPartInstanceId($arr[$keys[2]]);
		if (array_key_exists($keys[3], $arr)) $this->setQuantityCompleted($arr[$keys[3]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CustomerOrderItemPeer::ID)) $criteria->add(CustomerOrderItemPeer::ID, $this->id);
		if ($this->isColumnModified(CustomerOrderItemPeer::CUSTOMER_ORDER_ID)) $criteria->add(CustomerOrderItemPeer::CUSTOMER_ORDER_ID, $this->customer_order_id);
		if ($this->isColumnModified(CustomerOrderItemPeer::PART_INSTANCE_ID)) $criteria->add(CustomerOrderItemPeer::PART_INSTANCE_ID, $this->part_instance_id);
		if ($this->isColumnModified(CustomerOrderItemPeer::QUANTITY_COMPLETED)) $criteria->add(CustomerOrderItemPeer::QUANTITY_COMPLETED, $this->quantity_completed);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(CustomerOrderItemPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of CustomerOrderItem (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     CustomerOrderItem Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     CustomerOrderItemPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new CustomerOrderItemPeer();
		}
		return self::$peer;
	}
	...
	public function getCustomerOrder(PropelPDO $con = null)
	{
		if ($this->aCustomerOrder === null && ($this->customer_order_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aCustomerOrder->addCustomerOrderItems($this);
			 */
		}
	...
	public function getPartInstance(PropelPDO $con = null)
	{
		if ($this->aPartInstance === null && ($this->part_instance_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aPartInstance->addCustomerOrderItems($this);
			 */
		}
	 ...
	 * Otherwise if this CustomerOrderItem has previously been saved, it will retrieve
	 * related CustomerReturnItems from storage. If this CustomerOrderItem is new, it will return
		...
		if ($this->collCustomerReturnItems === null) {
			if ($this->isNew()) {
			   $this->collCustomerReturnItems = array();
				...
				$criteria->add(CustomerReturnItemPeer::CUSTOMER_ORDER_ITEM_ID, $this->id);
	 ...
	 * Otherwise if this CustomerOrderItem is new, it will return
	 * an empty collection; or if this CustomerOrderItem has previously
	 * been saved, it will retrieve related CustomerReturnItems from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in CustomerOrderItem.
	 */
	 ...
	 * actually need in CustomerOrderItem.
	 */
	public function getCustomerReturnItemsJoinPartInstance($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(CustomerOrderItemPeer::DATABASE_NAME);
		}
		...
		if ($this->collCustomerReturnItems === null) {
			if ($this->isNew()) {
				...
				$this->collCustomerReturnItems = CustomerReturnItemPeer::doSelectJoinPartInstance($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this CustomerOrderItem has previously been saved, it will retrieve
	 * related ShipmentItems from storage. If this CustomerOrderItem is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collShipmentItems === null) {
			if ($this->isNew()) {
			   $this->collShipmentItems = array();
				...
				$criteria->add(ShipmentItemPeer::CUSTOMER_ORDER_ITEM_ID, $this->id);
	 ...
	 * actually need in CustomerOrderItem.
	 */
	public function getShipmentItemsJoinShipment($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(CustomerOrderItemPeer::DATABASE_NAME);
		}
		...
		if ($this->collShipmentItems === null) {
			if ($this->isNew()) {
				...
				$this->collShipmentItems = ShipmentItemPeer::doSelectJoinShipment($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
  ...
  {
    if (!$callable = sfMixer::getCallable('BaseCustomerOrderItem:'.$method))
    {
      throw new sfException(sprintf('Call to undefined method BaseCustomerOrderItem::%s', $method));
    }
