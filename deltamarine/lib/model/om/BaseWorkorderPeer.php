...
abstract class BaseWorkorderPeer {
	...
	const E2B_IMPORT_DATE = 'workorder.E2B_IMPORT_DATE';

	const EXPIRED_DATE = 'workorder.EXPIRED_DATE';

	const DELIVERED_DATE = 'workorder.DELIVERED_DATE';

	const PICKUP_DATE = 'workorder.PICKUP_DATE';
	
	const FAXED = 'workorder.FAXED';

	const DELIVERED = 'workorder.DELIVERED';

	const DIVISION = 'workorder.DIVISION';
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(WorkorderPeer::E2B_IMPORT_DATE);

		$criteria->addSelectColumn(WorkorderPeer::EXPIRED_DATE);

		$criteria->addSelectColumn(WorkorderPeer::DELIVERED_DATE);

		$criteria->addSelectColumn(WorkorderPeer::PICKUP_DATE);

		$criteria->addSelectColumn(WorkorderPeer::FAXED);

		$criteria->addSelectColumn(WorkorderPeer::DELIVERED);

		$criteria->addSelectColumn(WorkorderPeer::DIVISION);
	}
