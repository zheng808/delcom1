...
abstract class BaseCustomerPeer {
	...
	const WF_CRM_ID = 'customer.WF_CRM_ID';

	/** the column name for the GUARD_USER_ID field */
	const GUARD_USER_ID = 'customer.GUARD_USER_ID';

	/** the column name for the PST_NUMBER field */
	const PST_NUMBER = 'customer.PST_NUMBER';

	/** the column name for the HIDDEN field */
	const HIDDEN = 'customer.HIDDEN';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'WfCrmId', 'GuardUserId', 'PstNumber', 'Hidden', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'wfCrmId', 'guardUserId', 'pstNumber', 'hidden', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::WF_CRM_ID, self::GUARD_USER_ID, self::PST_NUMBER, self::HIDDEN, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'wf_crm_id', 'guard_user_id', 'pst_number', 'hidden', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'WfCrmId' => 1, 'GuardUserId' => 2, 'PstNumber' => 3, 'Hidden' => 4, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'wfCrmId' => 1, 'guardUserId' => 2, 'pstNumber' => 3, 'hidden' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::WF_CRM_ID => 1, self::GUARD_USER_ID => 2, self::PST_NUMBER => 3, self::HIDDEN => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'wf_crm_id' => 1, 'guard_user_id' => 2, 'pst_number' => 3, 'hidden' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(CustomerPeer::WF_CRM_ID);

		$criteria->addSelectColumn(CustomerPeer::GUARD_USER_ID);

		$criteria->addSelectColumn(CustomerPeer::PST_NUMBER);

		$criteria->addSelectColumn(CustomerPeer::HIDDEN);
	...
	public static function doCountJoinwfCRM(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(CustomerPeer::WF_CRM_ID,), array(wfCRMPeer::ID,), $join_behavior);
	...
	public static function doCountJoinsfGuardUser(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(CustomerPeer::GUARD_USER_ID,), array(sfGuardUserPeer::ID,), $join_behavior);
	...
	/**
	 * Selects a collection of Customer objects pre-filled with their wfCRM objects.
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    foreach (sfMixer::getCallables('BaseCustomerPeer:doSelectJoin:doSelectJoin') as $callable)
    {
      call_user_func($callable, 'BaseCustomerPeer', $c, $con);
		...
		$c->addJoin(array(CustomerPeer::WF_CRM_ID,), array(wfCRMPeer::ID,), $join_behavior);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Customer) to $obj2 (wfCRM)
	...
	public static function doSelectJoinsfGuardUser(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$c->addJoin(array(CustomerPeer::GUARD_USER_ID,), array(sfGuardUserPeer::ID,), $join_behavior);
		$stmt = BasePeer::doSelect($c, $con);
		$results = array();
      ...
      call_user_func($callable, 'BaseCustomerPeer', $c, $con);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Customer) to the collection in $obj2 (wfCRM)
				$obj2->addCustomer($obj1);
	...
	/**
	 * Selects a collection of Customer objects pre-filled with all related objects except wfCRM.
	 *
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
