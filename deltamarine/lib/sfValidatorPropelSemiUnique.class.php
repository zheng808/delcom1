 ...
 */
class sfValidatorPropelSemiUnique extends sfValidatorSchema
{
  /**
   * Constructor.
   *
   ...
   *  * scope_field         if set, only checks rows within the same scope. 
  ...
  protected function doClean($values)
  {
    ...
    {
      $colName = call_user_func(array(constant($this->getOption('model').'::PEER'), 'translateFieldName'), $scope, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_COLNAME);

      $criteria->add($colName, $values[$scope]);
    }
