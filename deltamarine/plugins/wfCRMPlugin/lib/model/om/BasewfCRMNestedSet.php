...
require 'plugins/wfCRMPlugin/lib/model/om/BasewfCRM.php';
 ...
 */
abstract class BasewfCRMNestedSet extends BasewfCRM implements NodeObject {
	...
	public function save(PropelPDO $con = null)
	{
		...
		if (empty($left) || empty($right)) {
			$root = wfCRMPeer::retrieveRoot($this->getScopeIdValue(), $con);
			wfCRMPeer::insertAsLastChildOf($this, $root, $con);
		}
	...
	public function delete(PropelPDO $con = null)
	{
		...
		wfCRMPeer::deleteDescendants($this, $con);
	}
	...
	{
		if (null === $this->level) {
			$this->level = wfCRMPeer::getLevel($this, $con);
		}
		return $this->level;
	}
	...
	{
		return wfCRMPeer::getPath($this, $con);
	}
	...
	{
		return wfCRMPeer::getNumberOfChildren($this, $con);
	}
	...
	{
		return wfCRMPeer::getNumberOfDescendants($this, $con);
	}
	...
	public function getChildren(PropelPDO $con = null)
	{
		...
		return wfCRMPeer::retrieveChildren($this, $con);
	}
	 ...
	 *
	 * @param      array of wfCRM $children	array of Propel node object
	 * @return     wfCRM The current object (for fluent API support)
	 */
	 ...
	 *
	 * @param      wfCRM $parent Propel node object
	 * @return     wfCRM The current object (for fluent API support)
	 */
	public function setParentNode(NodeObject $parent = null)
	{
		$this->parentNode = (true === ($this->hasParentNode = wfCRMPeer::isValid($parent))) ? $parent : null;
		return $this;
	}
	 ...
	 *
	 * @param      wfCRM $node Propel node object
	 * @return     wfCRM The current object (for fluent API support)
	 */
	public function setPrevSibling(NodeObject $node = null)
	{
		$this->prevSibling = $node;
		$this->hasPrevSibling = wfCRMPeer::isValid($node);
		return $this;
	}
	...
	public function setNextSibling(NodeObject $node = null)
	{
		...
		$this->hasNextSibling = wfCRMPeer::isValid($node);
		return $this;
	}
	...
	{
		return wfCRMPeer::isEqualTo($this, $node);
	}
	...
	{
		return  wfCRMPeer::hasChildren($this);
	}
	...
	public function hasPrevSibling(PropelPDO $con = null)
	{
		if (null === $this->hasPrevSibling) {
			wfCRMPeer::hasPrevSibling($this, $con);
		}
	...
	public function hasNextSibling(PropelPDO $con = null)
	{
		if (null === $this->hasNextSibling) {
			wfCRMPeer::hasNextSibling($this, $con);
		}
	...
	{
		if (null === $this->hasParentNode) {
			$this->parentNode = wfCRMPeer::retrieveParent($this, $con);
			$this->hasParentNode = wfCRMPeer::isValid($this->parentNode);
		}
	...
	public function retrieveFirstChild(PropelPDO $con = null)
	{
		if ($this->hasChildren($con)) {
			...
			return wfCRMPeer::retrieveFirstChild($this, $con);
		}
		return false;
	}
	...
	public function retrieveLastChild(PropelPDO $con = null)
	{
		if ($this->hasChildren($con)) {
			...
			return wfCRMPeer::retrieveLastChild($this, $con);
		}
		return false;
	}
	 ...
	 *
	 * @param      wfCRM $parent	Propel object for destination node
	 * @param      PropelPDO $con Connection to use.
	 * @return     wfCRM The current object (for fluent API support)
	...
	public function insertAsFirstChildOf(NodeObject $parent, PropelPDO $con = null)
	{
		if (!$this->isNew())
		{
			throw new PropelException("wfCRM must be new.");
		}
		wfCRMPeer::insertAsFirstChildOf($this, $parent, $con);
		return $this;
	}
	...
	public function insertAsLastChildOf(NodeObject $parent, PropelPDO $con = null)
	{
		...
		wfCRMPeer::insertAsLastChildOf($this, $parent, $con);
		return $this;
	}
	...
	public function insertAsPrevSiblingOf(NodeObject $dest, PropelPDO $con = null)
	{
		...
		wfCRMPeer::insertAsPrevSiblingOf($this, $dest, $con);
		return $this;
	}
	...
	public function insertAsNextSiblingOf(NodeObject $dest, PropelPDO $con = null)
	{
		...
		wfCRMPeer::insertAsNextSiblingOf($this, $dest, $con);
		return $this;
	}
	...
	public function moveToFirstChildOf(NodeObject $parent, PropelPDO $con = null)
	{
		if ($this->isNew())
		{
			throw new PropelException("wfCRM must exist in tree.");
		}
		wfCRMPeer::moveToFirstChildOf($parent, $this, $con);
		return $this;
	}
	...
	public function moveToLastChildOf(NodeObject $parent, PropelPDO $con = null)
	{
		...
		wfCRMPeer::moveToLastChildOf($parent, $this, $con);
		return $this;
	}
	...
	public function moveToPrevSiblingOf(NodeObject $dest, PropelPDO $con = null)
	{
		...
		wfCRMPeer::moveToPrevSiblingOf($dest, $this, $con);
		return $this;
	}
	...
	public function moveToNextSiblingOf(NodeObject $dest, PropelPDO $con = null)
	{
		...
		wfCRMPeer::moveToNextSiblingOf($dest, $this, $con);
		return $this;
	}
	...
	{
		wfCRMPeer::insertAsParentOf($this, $node, $con);
		return $this;
	}
