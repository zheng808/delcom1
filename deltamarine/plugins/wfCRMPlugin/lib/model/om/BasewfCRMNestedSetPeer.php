...
require 'plugins/wfCRMPlugin/lib/model/om/BasewfCRMPeer.php';

/**
 * Base static class for performing query operations on the tree contained by the 'wf_crm' table.
 *
 * 
 *
 * @package    plugins.wfCRMPlugin.lib.model.om
 */
abstract class BasewfCRMNestedSetPeer extends BasewfCRMPeer implements NodePeer {

	/**
	 * Left column for the set
	 */
	const LEFT_COL = 'wf_crm.TREE_LEFT';

	/**
	 * Right column for the set
	 */
	const RIGHT_COL = 'wf_crm.TREE_RIGHT';

	/**
	 * Scope column for the set
	 */
	const SCOPE_COL = 'wf_crm.TREE_ID';

	/**
	 * Creates the supplied node as the root node.
	 *
	 * @param      wfCRM $node	Propel object for model
	 ...
	 * @return     wfCRM			Propel object for root node
	 */
	public static function retrieveRoot($scopeId = null, PropelPDO $con = null)
	{
		...
		return wfCRMPeer::doSelectOne($c, $con);
	}

	/**
	 * Inserts $child as first child of given $parent node
	 *
	 * @param      wfCRM $child	Propel object for child node
	 * @param      wfCRM $parent	Propel object for parent node
	 * @param      PropelPDO $con	Connection to use.
	 * @return     void
	 */
	 ...
	 *
	 * @param      wfCRM $node		Propel object for destination node
	 * @param      wfCRM $sibling	Propel object for source node
	 * @param      PropelPDO $con	Connection to use.
	 * @return     void
	 */
	 ...
	 *
	 * @param      wfCRM $parent	Propel object for given parent node
	 * @param      wfCRM $node	Propel object for given destination node
	 * @param      PropelPDO $con	Connection to use.
	 * @return     void
	 */
	 ...
	 *
	 * @param      wfCRM $node	Propel object as root node
	 * @param      PropelPDO $con	Connection to use.
	 * @return     void
	 */
	public static function insertRoot(NodeObject $node, PropelPDO $con = null)
	{
		...
		wfCRMPeer::insertAsParentOf(wfCRMPeer::retrieveRoot($sidv, $con), $node, $con);
	}
	 ...
	 * @param      wfCRM $child	Propel object to become child node
	 * @param      wfCRM $parent	Propel object as parent node
	 * @param      PropelPDO $con	Connection to use.
	 * @return     void
	 */
	...
	public static function deleteRoot($scopeId = null, PropelPDO $con = null)
	{
		...
		$root = wfCRMPeer::retrieveRoot($scopeId, $con);
		if (wfCRMPeer::getNumberOfChildren($root) == 1) {
			return wfCRMPeer::deleteNode($root, $con);
		} else {
			return false;
		}
	}
	 ...
	 * Delete $dest node
	 *
	 * @param      wfCRM $dest	Propel object node to delete
	 * @param      PropelPDO $con	Connection to use.
	 * @return     boolean		Deletion status
	 */
	public static function deleteNode(NodeObject $dest, PropelPDO $con = null)
	{
		if ($dest->getLeftValue() == 1) {
			...
			return wfCRMPeer::deleteRoot($con);
		}
	 ...
	 *
	 * @param      wfCRM $dest	Propel object for destination node
	 * @param      wfCRM $node	Propel object for source node
	 * @param      PropelPDO $con	Connection to use.
	 * @return     void
	 */
	 ...
	 *
	 * @param      wfCRM $node	Propel object for src node
	 * @param      PropelPDO $con	Connection to use.
	...
	public static function retrievePrevSibling(NodeObject $node, PropelPDO $con = null)
	{
		...
		$prevSibling = wfCRMPeer::doSelectOne($c, $con);
	...
	public static function retrieveNextSibling(NodeObject $node, PropelPDO $con = null)
	{
		...
		$nextSibling = wfCRMPeer::doSelectOne($c, $con);
	...
	public static function retrieveTree($scopeId = null, PropelPDO $con = null)
	{
		...
		$stmt = wfCRMPeer::doSelectStmt($c, $con);
		if (false !== ($row = $stmt->fetch(PDO::FETCH_NUM))) {
			$omClass = wfCRMPeer::getOMClass($row, 0);
			$cls = substr('.'.$omClass, strrpos('.'.$omClass, '.') + 1);

			$key = wfCRMPeer::getPrimaryKeyHashFromRow($row, 0);
			if (null === ($root = wfCRMPeer::getInstanceFromPool($key))) {
				$root = new $cls();
				$root->hydrate($row);
			}

			$root->setLevel(0);
			wfCRMPeer::hydrateDescendants($root, $stmt);
			wfCRMPeer::addInstanceToPool($root);
	 ...
	 *
	 * @param      wfCRM $node	Propel object for parent node
	 * @param      PropelPDO $con	Connection to use.
	 */
	public static function retrieveBranch(NodeObject $node, PropelPDO $con = null)
	{
		return wfCRMPeer::retrieveDescendants($node, $con);
	}
	...
	public static function retrieveChildren(NodeObject $node, PropelPDO $con = null)
	{
		...
		return wfCRMPeer::hydrateChildren($node, $stmt);
	}
	...
	public static function retrieveDescendants(NodeObject $node, PropelPDO $con = null)
	{
		...
		return wfCRMPeer::hydrateDescendants($node, $stmt);
	}
	...
	{
		$parent = wfCRMPeer::retrieveParent($node, $con);
		$siblings = wfCRMPeer::retrieveChildren($parent, $con);
	...
	public static function retrieveParent(NodeObject $node, PropelPDO $con = null)
	{
		...
		$parent = wfCRMPeer::doSelectOne($c, $con);
	...
	{
		$children = wfCRMPeer::retrieveChildren($node);
	 ...
	 *
	 * @param      wfCRM $node	Propel object of node to create path to
	 * @param      PropelPDO $con	Connection to use.
	 ...
	 *
	 * @param      wfCRM $child	Propel object for node
	 * @param      wfCRM $parent	Propel object for node
	 * @return     bool
	 */
	 ...
	 * @param      wfCRM $node1		Propel object for node
	 * @param      wfCRM $node2		Propel object for node
	 * @return     bool
	 */
	 ...
	 *
	 * @param      wfCRM $node		Propel object for node
	 * @param      PropelPDO $con		Connection to use.
	 * @return     bool
	 */
	public static function hasParent(NodeObject $node, PropelPDO $con = null)
	{
		return wfCRMPeer::isValid(wfCRMPeer::retrieveParent($node, $con));
	}
	...
	{
		return wfCRMPeer::isValid(wfCRMPeer::retrievePrevSibling($node, $con));
	}
	...
	{
		return wfCRMPeer::isValid(wfCRMPeer::retrieveNextSibling($node, $con));
	}
	...
	public static function deleteDescendants(NodeObject $node, PropelPDO $con = null)
	{
		...
		$result = wfCRMPeer::doDelete($c, $con);
	 ...
	 *
	 * @param      int/wfCRM $node	Primary key/instance of required node
	 * @param      PropelPDO $con		Connection to use.
	...
	public static function getNode($node, PropelPDO $con = null)
	{
		if (is_object($node)) {
			...
			$object = wfCRMPeer::retrieveByPK($node, $con);
	...
	protected static function updateLoadedNode(NodeObject $node, $delta, PropelPDO $con = null)
	{
		if (Propel::isInstancePoolingEnabled()) {
			...
			if (!empty($keys)) {
				...
				$criteria->add(wfCRMPeer::ID, $keys, Criteria::IN);

				$stmt = wfCRMPeer::doSelectStmt($criteria, $con);
				while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
					$key = wfCRMPeer::getPrimaryKeyHashFromRow($row, 0);
					if (null !== ($object = wfCRMPeer::getInstanceFromPool($key))) {
	 ...
	 *
	 * @param      wfCRM $node Propel object for node to update
	...
	protected static function shiftRLValues($first, $delta, PropelPDO $con = null, $scopeId = null)
	{
		...
		$whereCriteria = new Criteria(wfCRMPeer::DATABASE_NAME);
		...
		$valuesCriteria = new Criteria(wfCRMPeer::DATABASE_NAME);
		$valuesCriteria->add(
			self::LEFT_COL,
