...
require 'plugins/wfCRMPlugin/lib/model/om/BasewfCRMCategoryPeer.php';

/**
 * Base static class for performing query operations on the tree contained by the 'wf_crm_category' table.
 *
 * 
 *
 * @package    plugins.wfCRMPlugin.lib.model.om
 */
abstract class BasewfCRMCategoryNestedSetPeer extends BasewfCRMCategoryPeer implements NodePeer {

	/**
	 * Left column for the set
	 */
	const LEFT_COL = 'wf_crm_category.TREE_LEFT';

	/**
	 * Right column for the set
	 */
	const RIGHT_COL = 'wf_crm_category.TREE_RIGHT';

	/**
	 * Scope column for the set
	 */
	const SCOPE_COL = 'wf_crm_category.TREE_ID';

	/**
	 * Creates the supplied node as the root node.
	 *
	 * @param      wfCRMCategory $node	Propel object for model
	 ...
	 * @return     wfCRMCategory			Propel object for root node
	 */
	public static function retrieveRoot($scopeId = null, PropelPDO $con = null)
	{
		...
		return wfCRMCategoryPeer::doSelectOne($c, $con);
	}

	/**
	 * Inserts $child as first child of given $parent node
	 *
	 * @param      wfCRMCategory $child	Propel object for child node
	 * @param      wfCRMCategory $parent	Propel object for parent node
	 * @param      PropelPDO $con	Connection to use.
	 * @return     void
	 */
	 ...
	 * @param      wfCRMCategory $sibling	Propel object for source node
	 * @param      PropelPDO $con	Connection to use.
	 * @return     void
	 */
	 ...
	 *
	 * @param      wfCRMCategory $parent	Propel object for given parent node
	 * @param      wfCRMCategory $node	Propel object for given destination node
	 * @param      PropelPDO $con	Connection to use.
	 * @return     void
	 */
	 ...
	 *
	 * @param      wfCRMCategory $node	Propel object as root node
	 * @param      PropelPDO $con	Connection to use.
	 * @return     void
	 */
	public static function insertRoot(NodeObject $node, PropelPDO $con = null)
	{
		...
		wfCRMCategoryPeer::insertAsParentOf(wfCRMCategoryPeer::retrieveRoot($sidv, $con), $node, $con);
	}
	 ...
	 * @param      wfCRMCategory $child	Propel object to become child node
	 * @param      wfCRMCategory $parent	Propel object as parent node
	 * @param      PropelPDO $con	Connection to use.
	 * @return     void
	 */
	...
	public static function deleteRoot($scopeId = null, PropelPDO $con = null)
	{
		...
		$root = wfCRMCategoryPeer::retrieveRoot($scopeId, $con);
		if (wfCRMCategoryPeer::getNumberOfChildren($root) == 1) {
			return wfCRMCategoryPeer::deleteNode($root, $con);
		} else {
			return false;
		}
	}
	 ...
	 * Delete $dest node
	 *
	 * @param      wfCRMCategory $dest	Propel object node to delete
	 * @param      PropelPDO $con	Connection to use.
	 * @return     boolean		Deletion status
	 */
	public static function deleteNode(NodeObject $dest, PropelPDO $con = null)
	{
		if ($dest->getLeftValue() == 1) {
			...
			return wfCRMCategoryPeer::deleteRoot($con);
		}
	 ...
	 * @param      wfCRMCategory $node	Propel object for source node
	 * @param      PropelPDO $con	Connection to use.
	 * @return     void
	 */
	 ...
	 *
	 * @param      wfCRMCategory $node	Propel object for src node
	 * @param      PropelPDO $con	Connection to use.
	...
	public static function retrievePrevSibling(NodeObject $node, PropelPDO $con = null)
	{
		...
		$prevSibling = wfCRMCategoryPeer::doSelectOne($c, $con);
	...
	public static function retrieveNextSibling(NodeObject $node, PropelPDO $con = null)
	{
		...
		$nextSibling = wfCRMCategoryPeer::doSelectOne($c, $con);
	...
	public static function retrieveTree($scopeId = null, PropelPDO $con = null)
	{
		...
		$stmt = wfCRMCategoryPeer::doSelectStmt($c, $con);
		if (false !== ($row = $stmt->fetch(PDO::FETCH_NUM))) {
			$omClass = wfCRMCategoryPeer::getOMClass($row, 0);
			$cls = substr('.'.$omClass, strrpos('.'.$omClass, '.') + 1);

			$key = wfCRMCategoryPeer::getPrimaryKeyHashFromRow($row, 0);
			if (null === ($root = wfCRMCategoryPeer::getInstanceFromPool($key))) {
				$root = new $cls();
				$root->hydrate($row);
			}

			$root->setLevel(0);
			wfCRMCategoryPeer::hydrateDescendants($root, $stmt);
			wfCRMCategoryPeer::addInstanceToPool($root);
	 ...
	 *
	 * @param      wfCRMCategory $node	Propel object for parent node
	 * @param      PropelPDO $con	Connection to use.
	 */
	public static function retrieveBranch(NodeObject $node, PropelPDO $con = null)
	{
		return wfCRMCategoryPeer::retrieveDescendants($node, $con);
	}
	...
	public static function retrieveChildren(NodeObject $node, PropelPDO $con = null)
	{
		...
		return wfCRMCategoryPeer::hydrateChildren($node, $stmt);
	}
	...
	public static function retrieveDescendants(NodeObject $node, PropelPDO $con = null)
	{
		...
		return wfCRMCategoryPeer::hydrateDescendants($node, $stmt);
	}
	...
	{
		$parent = wfCRMCategoryPeer::retrieveParent($node, $con);
		$siblings = wfCRMCategoryPeer::retrieveChildren($parent, $con);
	...
	public static function retrieveParent(NodeObject $node, PropelPDO $con = null)
	{
		...
		$parent = wfCRMCategoryPeer::doSelectOne($c, $con);
	...
	{
		$children = wfCRMCategoryPeer::retrieveChildren($node);
	 ...
	 *
	 * @param      wfCRMCategory $node	Propel object of node to create path to
	 * @param      PropelPDO $con	Connection to use.
	 ...
	 *
	 * @param      wfCRMCategory $child	Propel object for node
	 * @param      wfCRMCategory $parent	Propel object for node
	 * @return     bool
	 */
	 ...
	 * @param      wfCRMCategory $node1		Propel object for node
	 * @param      wfCRMCategory $node2		Propel object for node
	 * @return     bool
	 */
	 ...
	 *
	 * @param      wfCRMCategory $node		Propel object for node
	 * @param      PropelPDO $con		Connection to use.
	 * @return     bool
	 */
	public static function hasParent(NodeObject $node, PropelPDO $con = null)
	{
		return wfCRMCategoryPeer::isValid(wfCRMCategoryPeer::retrieveParent($node, $con));
	}
	...
	{
		return wfCRMCategoryPeer::isValid(wfCRMCategoryPeer::retrievePrevSibling($node, $con));
	}
	...
	{
		return wfCRMCategoryPeer::isValid(wfCRMCategoryPeer::retrieveNextSibling($node, $con));
	}
	...
	public static function deleteDescendants(NodeObject $node, PropelPDO $con = null)
	{
		...
		$result = wfCRMCategoryPeer::doDelete($c, $con);
	 ...
	 *
	 * @param      int/wfCRMCategory $node	Primary key/instance of required node
	 * @param      PropelPDO $con		Connection to use.
	...
	public static function getNode($node, PropelPDO $con = null)
	{
		if (is_object($node)) {
			...
			$object = wfCRMCategoryPeer::retrieveByPK($node, $con);
	...
	protected static function updateLoadedNode(NodeObject $node, $delta, PropelPDO $con = null)
	{
		if (Propel::isInstancePoolingEnabled()) {
			...
			if (!empty($keys)) {
				...
				$criteria->add(wfCRMCategoryPeer::ID, $keys, Criteria::IN);

				$stmt = wfCRMCategoryPeer::doSelectStmt($criteria, $con);
				while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
					$key = wfCRMCategoryPeer::getPrimaryKeyHashFromRow($row, 0);
					if (null !== ($object = wfCRMCategoryPeer::getInstanceFromPool($key))) {
	 ...
	 *
	 * @param      wfCRMCategory $node Propel object for node to update
	...
	protected static function shiftRLValues($first, $delta, PropelPDO $con = null, $scopeId = null)
	{
		...
		$whereCriteria = new Criteria(wfCRMCategoryPeer::DATABASE_NAME);
		...
		$valuesCriteria = new Criteria(wfCRMCategoryPeer::DATABASE_NAME);
		$valuesCriteria->add(
			self::LEFT_COL,
...
} // BasewfCRMCategoryNestedSetPeer
