  ...
  static public function getUniqueColumnNames()
  {
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		try {
			...
			// invalidate objects in CustomerPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			$c->add(EmployeePeer::GUARD_USER_ID, $obj->getId());
			$affectedRows += EmployeePeer::doDelete($c, $con);

			// delete related Customer objects
			$c = new Criteria(CustomerPeer::DATABASE_NAME);
			
			$c->add(CustomerPeer::GUARD_USER_ID, $obj->getId());
			$affectedRows += CustomerPeer::doDelete($c, $con);
