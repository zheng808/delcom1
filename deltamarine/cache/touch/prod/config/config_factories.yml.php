...
'level' => 'debug',
'file' => '/var/www/delta/deltamarine/log/touch_prod.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => '/var/www/delta/deltamarine/cache/touch/prod/i18n',
  'lifetime' => 31556926,
  'prefix' => '/var/www/delta/deltamarine/apps/touch/i18n',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('delta_touch'),
), sfConfig::get('sf_factory_storage_parameters', array (
  'session_name' => 'delta_touch',
))));
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/var/www/delta/deltamarine/cache/touch/prod/template',
  'lifetime' => 86400,
  'prefix' => '/var/www/delta/deltamarine/apps/touch/template',
)));
