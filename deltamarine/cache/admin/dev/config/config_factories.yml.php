...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'debug',
  'file' => '/var/www/delta/deltamarine/log/admin_dev.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => '/var/www/delta/deltamarine/cache/admin/dev/i18n',
  'lifetime' => 31556926,
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('delta_admin'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/var/www/delta/deltamarine/cache/admin/dev/template',
  'lifetime' => 86400,
