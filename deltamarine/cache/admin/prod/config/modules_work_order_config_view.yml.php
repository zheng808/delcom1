...
// date: 2016/12/19 15:04:19
$response = $this->context->getResponse();

if ($this->actionName.$this->viewName == 'viewSuccess')
{
...
if ($templateName.$this->viewName == 'viewSuccess')
{
  ...
  $response->addMeta('title', 'Delta - Work Orders', false, false);
  ...
  $response->addJavascript('extWorkorder-161127', '', array ());
  $response->addJavascript('extTimelog-161010', '', array ());
}
else
{
  if (!is_null($layout = sfConfig::get('symfony.view.'.$this->moduleName.'_'.$this->actionName.'_layout')))
