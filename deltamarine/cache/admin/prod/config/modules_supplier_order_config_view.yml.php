...
// date: 2020/10/18 22:36:59
$response = $this->context->getResponse();

if ($this->actionName.$this->viewName == 'invoiceSuccess')
{
...
if ($templateName.$this->viewName == 'invoiceSuccess')
{
  ...
  $response->addMeta('title', 'Delta - Supplier Orders Management', false, false);

  $response->addStylesheet('base', '', array ());
  $response->addStylesheet('print', '', array (  'media' => 'all',));
}
else
{
  if (!is_null($layout = sfConfig::get('symfony.view.'.$this->moduleName.'_'.$this->actionName.'_layout')))
