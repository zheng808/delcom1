...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'debug',
  'file' => '/var/www/delta/deltamarine/log/admin_test.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => '/var/www/delta/deltamarine/cache/admin/test/i18n',
  'lifetime' => 31556926,
  'prefix' => '/var/www/delta/deltamarine/apps/admin/i18n',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('delta_admin'),
), sfConfig::get('sf_factory_storage_parameters', array (
  'session_name' => 'delta_admin',
  'session_path' => '/var/www/delta/deltamarine/cache/admin/test/test/sessions',
))));
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/var/www/delta/deltamarine/cache/admin/test/template',
  'lifetime' => 86400,
  'prefix' => '/var/www/delta/deltamarine/apps/admin/template',
)));
